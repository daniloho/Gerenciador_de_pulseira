 ...
 */
package nodomain.freeyourgadget.Pulseira.daogen;
...
public class GBDaoGenerator {
    ...
    private static final String MAIN_PACKAGE = "nodomain.freeyourgadget.Pulseira";
    ...
    private static void addAlarms(Schema schema, Entity user, Entity device) {
        ...
        alarm.implementsInterface("nodomain.freeyourgadget.Pulseira.model.Alarm");
