...
package nodomain.freeyourgadget.Pulseira;
...
import nodomain.freeyourgadget.Pulseira.database.DBOpenHelper;
import nodomain.freeyourgadget.Pulseira.devices.DeviceManager;
import nodomain.freeyourgadget.Pulseira.entities.DaoMaster;
import nodomain.freeyourgadget.Pulseira.entities.DaoSession;
import nodomain.freeyourgadget.Pulseira.entities.Device;
import nodomain.freeyourgadget.Pulseira.externalevents.BluetoothStateChangeReceiver;
import nodomain.freeyourgadget.Pulseira.impl.GBDevice;
import nodomain.freeyourgadget.Pulseira.impl.GBDeviceService;
...
import nodomain.freeyourgadget.Pulseira.service.NotificationCollectorMonitorService;
import nodomain.freeyourgadget.Pulseira.util.AndroidUtils;
import nodomain.freeyourgadget.Pulseira.util.FileUtils;
import nodomain.freeyourgadget.Pulseira.util.GB;
import nodomain.freeyourgadget.Pulseira.util.GBPrefs;
import nodomain.freeyourgadget.Pulseira.util.LimitedQueue;
import nodomain.freeyourgadget.Pulseira.util.Prefs;

import static nodomain.freeyourgadget.Pulseira.model.DeviceType.AMAZFITBIP;
import static nodomain.freeyourgadget.Pulseira.model.DeviceType.AMAZFITCOR;
import static nodomain.freeyourgadget.Pulseira.model.DeviceType.AMAZFITCOR2;
import static nodomain.freeyourgadget.Pulseira.model.DeviceType.MIBAND;
import static nodomain.freeyourgadget.Pulseira.model.DeviceType.MIBAND2;
import static nodomain.freeyourgadget.Pulseira.model.DeviceType.MIBAND3;
import static nodomain.freeyourgadget.Pulseira.model.DeviceType.fromKey;
import static nodomain.freeyourgadget.Pulseira.util.GB.NOTIFICATION_CHANNEL_ID;
...
public class GBApplication extends Application {
    ...
    public static final String ACTION_QUIT
            = "nodomain.freeyourgadget.Pulseira.gbapplication.action.quit";
    public static final String ACTION_LANGUAGE_CHANGE = "nodomain.freeyourgadget.Pulseira.gbapplication.action.language_change";
    public static final String ACTION_NEW_DATA = "nodomain.freeyourgadget.Pulseira.action.new_data";
