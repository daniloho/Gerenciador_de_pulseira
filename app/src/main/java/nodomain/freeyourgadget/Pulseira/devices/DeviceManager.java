...
public class DeviceManager {
    ...
    public static final String ACTION_DEVICES_CHANGED
            = "nodomain.freeyourgadget.Pulseira.devices.devicemanager.action.devices_changed";
    /**
    ...
    public static final String ACTION_REFRESH_DEVICELIST
            = "nodomain.freeyourgadget.Pulseira.devices.devicemanager.action.set_version";
