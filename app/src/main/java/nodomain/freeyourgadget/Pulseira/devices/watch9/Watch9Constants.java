...
public final class Watch9Constants {
    ...
    public static final String ACTION_CALIBRATION
            = "nodomain.freeyourgadget.Pulseira.devices.action.watch9.start_calibration";
    public static final String ACTION_CALIBRATION_SEND
            = "nodomain.freeyourgadget.Pulseira.devices.action.watch9.send_calibration";
    public static final String ACTION_CALIBRATION_HOLD
            = "nodomain.freeyourgadget.Pulseira.devices.action.watch9.keep_calibrating";
