...
import nodomain.freeyourgadget.Pulseira.service.devices.pebble.webview.GBChromeClient;
import nodomain.freeyourgadget.Pulseira.service.devices.pebble.webview.GBWebClient;
import nodomain.freeyourgadget.Pulseira.service.devices.pebble.webview.JSInterface;
...
public class ExternalPebbleJSActivity extends AbstractGBActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras == null) {
            ...
            if(confUri.getScheme().equals("Pulseira")) {
                try {
