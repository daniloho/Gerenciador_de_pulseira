package nodomain.freeyourgadget.Pulseira.activities.devicesettings;
...
import nodomain.freeyourgadget.Pulseira.devices.makibeshr3.MakibesHR3Constants;
import nodomain.freeyourgadget.Pulseira.devices.miband.MiBandConst;
import nodomain.freeyourgadget.Pulseira.util.Prefs;
import nodomain.freeyourgadget.Pulseira.util.XTimePreference;
import nodomain.freeyourgadget.Pulseira.util.XTimePreferenceFragment;

import static nodomain.freeyourgadget.Pulseira.activities.devicesettings.DeviceSettingsPreferenceConst.*;
import static nodomain.freeyourgadget.Pulseira.devices.huami.HuamiConst.PREF_ACTIVATE_DISPLAY_ON_LIFT;
import static nodomain.freeyourgadget.Pulseira.devices.huami.HuamiConst.PREF_DISCONNECT_NOTIFICATION;
import static nodomain.freeyourgadget.Pulseira.devices.huami.HuamiConst.PREF_DISCONNECT_NOTIFICATION_END;
import static nodomain.freeyourgadget.Pulseira.devices.huami.HuamiConst.PREF_DISCONNECT_NOTIFICATION_START;
import static nodomain.freeyourgadget.Pulseira.devices.huami.HuamiConst.PREF_DISPLAY_ITEMS;
import static nodomain.freeyourgadget.Pulseira.devices.huami.HuamiConst.PREF_DISPLAY_ON_LIFT_END;
import static nodomain.freeyourgadget.Pulseira.devices.huami.HuamiConst.PREF_DISPLAY_ON_LIFT_START;
import static nodomain.freeyourgadget.Pulseira.devices.huami.HuamiConst.PREF_EXPOSE_HR_THIRDPARTY;
import static nodomain.freeyourgadget.Pulseira.devices.huami.HuamiConst.PREF_LANGUAGE;
import static nodomain.freeyourgadget.Pulseira.devices.miband.MiBandConst.PREF_DO_NOT_DISTURB;
import static nodomain.freeyourgadget.Pulseira.devices.miband.MiBandConst.PREF_DO_NOT_DISTURB_END;
import static nodomain.freeyourgadget.Pulseira.devices.miband.MiBandConst.PREF_DO_NOT_DISTURB_OFF;
import static nodomain.freeyourgadget.Pulseira.devices.miband.MiBandConst.PREF_DO_NOT_DISTURB_SCHEDULED;
import static nodomain.freeyourgadget.Pulseira.devices.miband.MiBandConst.PREF_DO_NOT_DISTURB_START;
import static nodomain.freeyourgadget.Pulseira.devices.miband.MiBandConst.PREF_MI2_DATEFORMAT;
import static nodomain.freeyourgadget.Pulseira.devices.miband.MiBandConst.PREF_MI2_ROTATE_WRIST_TO_SWITCH_INFO;
import static nodomain.freeyourgadget.Pulseira.devices.miband.MiBandConst.PREF_NIGHT_MODE;
import static nodomain.freeyourgadget.Pulseira.devices.miband.MiBandConst.PREF_NIGHT_MODE_END;
import static nodomain.freeyourgadget.Pulseira.devices.miband.MiBandConst.PREF_NIGHT_MODE_OFF;
import static nodomain.freeyourgadget.Pulseira.devices.miband.MiBandConst.PREF_NIGHT_MODE_SCHEDULED;
import static nodomain.freeyourgadget.Pulseira.devices.miband.MiBandConst.PREF_NIGHT_MODE_START;
import static nodomain.freeyourgadget.Pulseira.devices.miband.MiBandConst.PREF_SWIPE_UNLOCK;
