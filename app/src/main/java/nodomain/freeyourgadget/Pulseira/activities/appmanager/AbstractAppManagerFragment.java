...
package nodomain.freeyourgadget.Pulseira.activities.appmanager;
...
import nodomain.freeyourgadget.Pulseira.adapter.GBDeviceAppAdapter;
...
import nodomain.freeyourgadget.Pulseira.service.devices.pebble.PebbleProtocol;
...
public abstract class AbstractAppManagerFragment extends Fragment {
    public static final String ACTION_REFRESH_APPLIST
            = "nodomain.freeyourgadget.Pulseira.appmanager.action.refresh_applist";
