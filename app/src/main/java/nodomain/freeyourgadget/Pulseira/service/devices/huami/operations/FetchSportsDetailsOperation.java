...
package nodomain.freeyourgadget.Pulseira.service.devices.huami.operations;
...
import nodomain.freeyourgadget.Pulseira.entities.BaseActivitySummary;
import nodomain.freeyourgadget.Pulseira.export.ActivityTrackExporter;
import nodomain.freeyourgadget.Pulseira.export.GPXExporter;
import nodomain.freeyourgadget.Pulseira.model.ActivityKind;
import nodomain.freeyourgadget.Pulseira.model.ActivityTrack;
...
import nodomain.freeyourgadget.Pulseira.service.devices.huami.HuamiActivityDetailsParser;
...
//        }
        ...
        if (success) {
            ...
            try {
                ...
                String fileName = FileUtils.makeValidFileName("Pulseira-"+trackType.toLowerCase()+"-" + DateTimeUtils.formatIso8601(summary.getStartTime()) + ".gpx");
