...
package nodomain.freeyourgadget.Pulseira.service.receivers;
...
public class GBMusicControlReceiver extends BroadcastReceiver {
    ...
    public static final String ACTION_MUSICCONTROL = "nodomain.freeyourgadget.Pulseira.musiccontrol";
