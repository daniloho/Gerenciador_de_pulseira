...
package nodomain.freeyourgadget.Pulseira.util;
...
import nodomain.freeyourgadget.Pulseira.GBException;
...
import nodomain.freeyourgadget.Pulseira.devices.UnknownDeviceCoordinator;
import nodomain.freeyourgadget.Pulseira.devices.casiogb6900.CasioGB6900DeviceCoordinator;
import nodomain.freeyourgadget.Pulseira.devices.hplus.EXRIZUK8Coordinator;
import nodomain.freeyourgadget.Pulseira.devices.hplus.HPlusCoordinator;
import nodomain.freeyourgadget.Pulseira.devices.hplus.MakibesF68Coordinator;
import nodomain.freeyourgadget.Pulseira.devices.huami.amazfitbip.AmazfitBipLiteCoordinator;
import nodomain.freeyourgadget.Pulseira.devices.huami.amazfitgtr.AmazfitGTRCoordinator;
import nodomain.freeyourgadget.Pulseira.devices.huami.amazfitgts.AmazfitGTSCoordinator;
import nodomain.freeyourgadget.Pulseira.devices.makibeshr3.MakibesHR3Coordinator;
import nodomain.freeyourgadget.Pulseira.devices.hplus.Q8Coordinator;
import nodomain.freeyourgadget.Pulseira.devices.huami.amazfitbip.AmazfitBipCoordinator;
import nodomain.freeyourgadget.Pulseira.devices.huami.amazfitcor.AmazfitCorCoordinator;
import nodomain.freeyourgadget.Pulseira.devices.huami.amazfitcor2.AmazfitCor2Coordinator;
import nodomain.freeyourgadget.Pulseira.devices.huami.miband2.MiBand2Coordinator;
import nodomain.freeyourgadget.Pulseira.devices.huami.miband2.MiBand2HRXCoordinator;
import nodomain.freeyourgadget.Pulseira.devices.huami.miband3.MiBand3Coordinator;
import nodomain.freeyourgadget.Pulseira.devices.huami.miband4.MiBand4Coordinator;
import nodomain.freeyourgadget.Pulseira.devices.id115.ID115Coordinator;
import nodomain.freeyourgadget.Pulseira.devices.jyou.BFH16DeviceCoordinator;
import nodomain.freeyourgadget.Pulseira.devices.jyou.TeclastH30Coordinator;
import nodomain.freeyourgadget.Pulseira.devices.liveview.LiveviewCoordinator;
...
import nodomain.freeyourgadget.Pulseira.devices.mijia_lywsd02.MijiaLywsd02Coordinator;
import nodomain.freeyourgadget.Pulseira.devices.miscale2.MiScale2DeviceCoordinator;
import nodomain.freeyourgadget.Pulseira.devices.no1f1.No1F1Coordinator;
import nodomain.freeyourgadget.Pulseira.devices.pebble.PebbleCoordinator;
import nodomain.freeyourgadget.Pulseira.devices.roidmi.Roidmi1Coordinator;
import nodomain.freeyourgadget.Pulseira.devices.roidmi.Roidmi3Coordinator;
import nodomain.freeyourgadget.Pulseira.devices.vibratissimo.VibratissimoCoordinator;
import nodomain.freeyourgadget.Pulseira.devices.watch9.Watch9DeviceCoordinator;
import nodomain.freeyourgadget.Pulseira.devices.xwatch.XWatchCoordinator;
import nodomain.freeyourgadget.Pulseira.devices.zetime.ZeTimeCoordinator;
import nodomain.freeyourgadget.Pulseira.entities.Device;
import nodomain.freeyourgadget.Pulseira.entities.DeviceAttributes;
