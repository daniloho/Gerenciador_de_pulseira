...
public class AlarmUtils {
     ...
     * @return
     */
    public static nodomain.freeyourgadget.Pulseira.model.Alarm createSingleShot(int index, boolean smartWakeup, Calendar calendar) {
     ...
     * @return
     */
    public static Calendar toCalendar(nodomain.freeyourgadget.Pulseira.model.Alarm alarm) {
