...
import nodomain.freeyourgadget.Pulseira.devices.amazfitbip.BipActivitySummary;
...
import nodomain.freeyourgadget.Pulseira.model.ActivityPoint;
...
public class HuamiActivityDetailsParserTest extends TestBase {
    ...
    public void testGPXExport() throws Exception {
        ...
        try (InputStream in = getContents(DETAILS_1)) {
            ...
            File targetFile = File.createTempFile("Pulseira-track", ".gpx");
